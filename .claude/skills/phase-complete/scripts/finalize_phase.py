'''phase-complete Part A — mark a phase done (mechanical cross-file bookkeeping).
...
index done-markers happen at release time (cut_release.py), because the version is only known then.
    ...
    .venv/Scripts/python .claude/skills/phase-complete/scripts/finalize_phase.py P-16 [--dry-run]
'''
